...
static NSString *MY_BANNER_UNIT_ID=@"a1510e68ad9c726";   //InstaHat
...
- (void)setupGAD{
	...
	_gadView = [[GADBannerView alloc]initWithAdSize:kGADAdSizeSmartBannerPortrait origin:CGPointZero];
