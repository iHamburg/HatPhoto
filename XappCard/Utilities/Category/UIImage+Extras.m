...
- (void)saveWithName:(NSString*)fileName{
	NSData *data = UIImageJPEGRepresentation(self, kJPEGCompressionQuality);
    
	NSString *filePath = [NSString dataFilePath:fileName];
...
- (void)saveWithPNGName:(NSString*)fileName{
